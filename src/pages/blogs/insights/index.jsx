...
export async function getServerSideProps(context) {
    ...
    const data = response?.data?.article_detail;
...
const Insights = ({ data }) => {
    ...
    const note_type = searchParams.get('type')
  ...
  return (
    ...
    <Head>
        ...
        <meta property="og:url" content={`https://www.goindiastocks.com/blogs/insights?type=${note_type}&id=${note_id}`} />
        <meta property="og:image" content="https://www.goindiastocks.in/Content/assets/images/seoshare.PNG"/>
                ...
                <div className=' flex flex-col mx-1 md:mx-5 md:mt-6'>
                    <div className='w-full flex flex-col lg:pr-2 border-gray-300'>
                        ...
                        <div className="md:px-3 lg:px-5 md:mx-20 lg:mx-56 md:flex flex-row my-3 p-1 py-2 justify-between hidden border-t border-b border-[#B7B7B7] ">
                            ...
                            <button className='flex flex-row items-center justify-center'
                                onClick={() => {
                                    navigator.clipboard.writeText(`${window.location.origin}/blogs/insights?type=${note_type}&id=${note_id}`);
                            ...
                            <div className='flex flex-row justify-between w-full border-t border-b border-black p-1 py-2 my-3'>
                                ...
                                <button className='flex flex-row items-center justify-center'
                                        onClick={() => {
                                                ...
                                                tempInput.value = `${window.location.origin}/blogs/insights?type=${note_type}&id=${note_id}`;
