  ...
  return (
    <>
      <div className="h-[calc(100vh-80px)] bg-white  overflow-y-auto scrollbar-none lg:scrollbar px-2">
        {!dashFincode ? (<>
            <div className="md:mx-2 p-2 pb-8 border shadow-md mt-2 rounded-md h-[70vh] flex items-center justify-center">
              <p className="bg-[#0d2844] p-5 rounded-md text-white">Search any Company!</p>
            </div>
          </>) : (<>
...
export default ValuationPageIndex;
